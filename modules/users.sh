...
try:
    ...
    if net == 'ws':
        ...
        print(f'      x-padding-obfs-mode: true')
        print(f'      x-padding-method: tokenish')
        print(f'      x-padding-placement: queryInHeader')
        print(f'      x-padding-header: X-Cache')
        print(f'      x-padding-key: _dc')
        print(f'      uplink-http-method: PUT')
        print(f'      session-placement: cookie')
        print(f'      seq-placement: header')
