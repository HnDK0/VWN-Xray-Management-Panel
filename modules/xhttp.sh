...
showXhttpQR() {
    ...
    local link
    link="vless://${uuid}@${domain}:443?security=tls&type=xhttp&path=${path_encoded}&mode=packet-up&alpn=h2%2Chttp%2F1.1&host=${domain}&sni=${domain}&fp=chrome&allowInsecure=0#${v_encoded_name}"
